export default function TechStack() {
  return (
    <section id="services" className="section-container">
      ...
      <div className="mb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="glass-card-hover p-8">
            ...
            <h3 className="text-xl font-bold text-white mb-3">Ranking Signals That Google Loves</h3>
            <p className="text-[#8B949E]">
              Leveraging Google&apos;s own properties — Docs, Sheets, Sites — to create
              high-authority signal stacks that boost your local relevance.
            </p>
          </div>
          ...
          <div className="glass-card-hover p-8">
            ...
            <h3 className="text-xl font-bold text-white mb-3">Multi-Platform Presence Building</h3>
            <p className="text-[#8B949E]">
              Content distributed across cloud platforms and high-authority sites, ensuring maximum
              indexing and broad digital footprint.
            </p>
          </div>
        </div>
      </div>

      {/* Bucket 2 — Content That Ranks */}
      <div className="mb-10">
        <h3 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
          <span className="w-2 h-2 rounded-full bg-green-500 inline-block" />
          Content That Ranks
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="glass-card-hover p-8">
            ...
            <h3 className="text-xl font-bold text-white mb-3">YouTube Content</h3>
            <p className="text-[#8B949E]">
              SEO-optimized video content targeting your local keywords, building authority and
              driving engagement signals.
            </p>
          </div>
          ...
          <div className="glass-card-hover p-8">
            ...
            <h3 className="text-xl font-bold text-white mb-3">Authority Articles</h3>
            <p className="text-[#8B949E]">
      ...
      <div className="mb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="glass-card-hover p-8">
            ...
            <h3 className="text-xl font-bold text-white mb-3">Smart Keyword Strategy</h3>
            <p className="text-[#8B949E]">
              AI-driven keyword clustering for maximum topical coverage — targeting the exact
              search terms your customers actually use.
            </p>
          </div>

          {/* Bi-Weekly Reports (moved from callout) */}
          <div className="glass-card-hover p-8">
            <div className="mb-6">
              <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <h3 className="text-xl font-bold text-white mb-3">Bi-Weekly Geo-Grid Reports</h3>
            <p className="text-[#8B949E]">
      ...
      {/* Pricing CTA */}
      <div className="glass-card p-8 md:p-10 max-w-3xl mx-auto text-center mt-12 border-[#00E676]/20">
